...
/**
 * Upgraded version of original {@link OAuth2Template}.
 * OAuth2Operations implementation that uses REST-template to make the OAuth calls.
 * @author Keith Donald
 * @author Roy Clarkson
 */
public class OAuth2Template2 implements OAuth2Operations {

	protected String PARAM_NAME_CLIENT_ID = "client_id";			//overridable
	protected String PARAM_NAME_CLIENT_SECRET = "client_secret";	//overridable
	...
	/**
	 * Constructs an OAuth2Template2 for a given set of client credentials. 
	 ...
	 */
	public OAuth2Template2(String clientId, String clientSecret, String authorizeUrl, String accessTokenUrl) {
	 ...
	 * @param accessTokenUrl the URL at which an authorization code, or user credentials may be exchanged for an access token
	 */
	public OAuth2Template2(String clientId, String clientSecret, String authorizeUrl, String authenticateUrl, String accessTokenUrl) {
	 ...
	 */
	public OAuth2Template2(String clientId, String clientSecret, String authorizeUrl, String authenticateUrl, String accessTokenUrl, String refreshTokenUrl) {
		...
		String clientInfo = "?"+PARAM_NAME_CLIENT_ID+"=" + formEncode(clientId);
	...
	public AccessGrant exchangeForAccess(String authorizationCode, String redirectUri, MultiValueMap<String, String> additionalParameters) {
		...
		if (useParametersForClientAuthentication) {
			params.set(PARAM_NAME_CLIENT_ID, clientId);
			params.set(PARAM_NAME_CLIENT_SECRET, clientSecret);
		}
