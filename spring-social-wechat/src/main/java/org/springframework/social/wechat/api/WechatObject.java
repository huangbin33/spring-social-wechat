...
/**
 * Base class for all Wechat types.
 * Offers an extraData property for carrying any data in response from Wechat that won't be otherwise mapped to any properties of the subclass.
 * @author Craig Walls
 */
